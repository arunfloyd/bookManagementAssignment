...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="relative text-white text-3xl md:text-5xl font-bold mb-8 z-10 text-center">
        Welcome to our Bookstore!
      </h1>
      <div className="relative z-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8 w-full max-w-3xl">
        <input
          type="text"
      ...
      <Link to={"/login"} className="relative z-10 mt-8">
